...
function Inputs() {
    return (
        ...
        <div className=" flex flex-row justify-center my-6">
            <div className=" flex flex-row w-3/4 items-center justify-around space-x-4 ">
                <input type="text"
                    placeholder="Search for city...."
                    className=" flex text-xl font-light p-2 w-full shadow-xl focus:outline-none capitalize placeholder:lowercase" />
